...
1. PyCharm에서 이 폴더(nlp_model_project)를 Open 합니다.
...
requirements.txt 의 버전 수정하고 나서
```bash
pip uninstall -y numpy torch torchtext torchvision torchaudio pytorch-lightning torchmetrics
pip cache purge
